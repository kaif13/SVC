  ...
  const stats = [
    {
      ...
      value: collegeData.stats.students,
      icon: (
        <svg
    ...
    },
    {
      ...
      value: collegeData.stats.faculty,
      icon: (
        <svg
          className="h-8 w-8 text-primary-600"
          fill="none"
    ...
    },
    {
      ...
      value: collegeData.stats.courses,
      icon: (
        <svg
          className="h-8 w-8 text-primary-600"
          fill="none"
    ...
    },
    {
      ...
      value: collegeData.stats.placements,
      icon: (
        <svg
          className="h-8 w-8 text-primary-600"
          fill="none"
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {stats.map((stat, index) => (
            <div key={index} className="text-center">
              ...
              <div className="mt-4">
                <div className="text-3xl font-bold text-primary-900 sm:text-4xl">
                  {stat.value}
                </div>
                <div className="mt-2 text-sm font-medium text-secondary-600 uppercase tracking-wide">
                  {stat.label}
                </div>
              </div>
            </div>
